...
static const UInt8 publicKeyIdentifier[] = "com.domain.app.publickey\0";
static const UInt8 privateKeyIdentifier[] = "com.domain.app.privatekey\0";
...
+(Security *)sharedInstance
{
    ...
    static Security *sharedInstance = nil;
    static dispatch_once_t onceToken = 0;
    dispatch_once(&onceToken, ^
    {
        sharedInstance = [[Security alloc] init];
...
-(NSString *)signWithPrivateKey:(NSString* )string
{
    ...
    NSData *someData = [Security sha256:[string dataUsingEncoding:NSUTF8StringEncoding]];
    ...
    NSString *str = [[NSString alloc] initWithData:[[Security getSignatureBytes:[string dataUsingEncoding:NSUTF8StringEncoding] withPrivateKey:privateKey] base64EncodedDataWithOptions:0]
...
+ (NSData *)getSignatureBytes:(NSData *)plainText withPrivateKey:(SecKeyRef)privateKey
{
    ...
    status = SecKeyRawSign(privateKey,
            ...
            (const uint8_t *)[[Security sha256:plainText] bytes],
